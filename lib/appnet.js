...
exports.userPosts = function(req, client, callback) {
  ...
  request.get({ uri: APPNET_URL + '/users/' + userId + '/posts?' + qs.stringify(params), timeout: TIMEOUT },
...
exports.getUser = function(req, callback) {
  ...
  request.get({ uri: APPNET_URL + '/users/@' + req.params.username + '?' + qs.stringify(params), timeout: TIMEOUT },
    function(err, resp, body) {
...
exports.myFeed = function(req, client, callback) {
  ...
  userDb.getSettings(req, client, function(err, userItems) {
    if (err) {
      ...
      request.get({ uri: APPNET_URL + '/posts/stream?' + qs.stringify(params), timeout: TIMEOUT },
        function(err, resp, body) {
...
exports.userMentions = function(req, callback) {
  ...
  request.get({ uri: APPNET_URL + '/users/' + userId + '/mentions?' + qs.stringify(params), timeout: TIMEOUT },
    function(err, resp, body) {
...
exports.userStarred = function(req, client, callback) {
  ...
  request.get({ uri: APPNET_URL + '/users/' + userId + '/stars?' + qs.stringify(params), timeout: TIMEOUT },
    function(err, resp, body) {
...
exports.globalFeed = function(req, callback) {
  ...
  request.get({ uri: APPNET_URL + '/posts/stream/global?' + qs.stringify(params), timeout: TIMEOUT },
    function(err, resp, body) {
...
exports.deleteMessage = function(req, client, callback) {
  ...
  request.del({ uri: APPNET_URL + '/posts/' + postId + '?' + qs.stringify(params), timeout: TIMEOUT },
    function(err, resp, body) {
...
exports.repost = function(req, client, callback) {
  ...
  request.post({ uri: APPNET_URL + '/posts/' + postId + '/repost?' + qs.stringify(params), timeout: TIMEOUT },
    function(err, resp, body) {
...
exports.unrepost = function(req, client, callback) {
  ...
  request.del({ uri: APPNET_URL + '/posts/' + postId + '/repost?' + qs.stringify(params), timeout: TIMEOUT },
    function(err, resp, body) {
...
exports.unstarMessage = function(req, client, callback) {
  ...
  request.del({ uri: APPNET_URL + '/posts/' + postId + '/star?' + qs.stringify(params), timeout: TIMEOUT },
    function(err, resp, body) {
...
exports.unfollow = function(req, client, callback) {
  ...
  request.del({ uri: APPNET_URL + '/users/' + userId + '/follow?' + qs.stringify(params), timeout: TIMEOUT },
    function(err, resp, body) {
...
exports.unmute = function(req, client, callback) {
  ...
  request.del({ uri: APPNET_URL + '/users/' + userId + '/mute?' + qs.stringify(params), timeout: TIMEOUT },
    function(err, resp, body) {
...
exports.followers = function(req, callback) {
  ...
  request.get({ uri: APPNET_URL + '/users/' + userId + '/followers?' + qs.stringify(params), timeout: TIMEOUT },
    function(err, resp, body) {
...
exports.following = function(req, callback) {
  ...
  request.get({ uri: APPNET_URL + '/users/' + userId + '/following?' + qs.stringify(params), timeout: TIMEOUT },
    function(err, resp, body) {
...
exports.thread = function(req, callback) {
  ...
  request.get({ uri: APPNET_URL + '/posts/' + postId + '/replies?' + qs.stringify(params), timeout: TIMEOUT },
    function(err, resp, body) {
...
exports.getTags = function(req, callback) {
  ...
  request.get({ uri: APPNET_URL + '/posts/tag/' + tag + '?' + qs.stringify(params), timeout: TIMEOUT },
    function(err, resp, body) {
...
exports.getPost = function(req, callback) {
  ...
  request.get({ uri: APPNET_URL + '/posts/' + postId + '?' + qs.stringify(params), timeout: TIMEOUT },
    function(err, resp, body) {
...
exports.starredUsers = function(req, callback) {
  ...
  request.get({ uri: APPNET_URL + '/posts/' + postId + '/stars?' + qs.stringify(params), timeout: TIMEOUT },
    function(err, resp, body) {
...
exports.repostedUsers = function(req, callback) {
  ...
  request.get({ uri: APPNET_URL + '/posts/' + postId + '/reposters?' + qs.stringify(params), timeout: TIMEOUT },
    function(err, resp, body) {

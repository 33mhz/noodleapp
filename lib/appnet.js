...
var APPNET_URL = 'https://api.pnut.io/v0';
var TIMEOUT = 20000;
var THREAD_MAX = 150;
...
exports.repost = function(req, client, callback) {
  ...
  var uri = APPNET_URL + '/posts/' + postId + '/repost?' + qs.stringify(params);
...
exports.starMessage = function(req, client, callback) {
  ...
  var uri = APPNET_URL + '/posts/' + postId + '/bookmark?' + qs.stringify(params);
...
exports.follow = function(req, client, callback) {
  ...
  var uri = APPNET_URL + '/users/' + userId + '/follow?' + qs.stringify(params);
...
exports.mute = function(req, client, callback) {
  ...
  var uri = APPNET_URL + '/users/' + userId + '/mute?' + qs.stringify(params);

...
exports.process = function(media, remix, quoteFix) {
  if (!remix.isMatched && quoteFix.match(SERVICE_INSTAGRAM)) {
    var parts = media.split('/');
    var shortcode = parts[parts.length - 2];

    remix.isMatched = true;

    remix.result = '<div class="image-wrapper"><a href="' + quoteFix + '">' +
      '<img src="http://instagr.am/p/' + shortcode + '/media/"/></a></div><a href="' + quoteFix +
